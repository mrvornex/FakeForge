...
const ENDPOINTS: Endpoint[] = [
  {
    ...
    code: `const res = await fetch('https://fakeforge.vercel.app/posts?limit=10');
...
// { posts: [...], total: 251, skip: 0, limit: 10 }`,
  },
  {
    ...
    code: `const res = await fetch('https://fakeforge.vercel.app/posts/1');
...
// { id: 1, title: "...", body: "...", tags: [...], userId: 5, views: 1200 }`,
  },
  {
    ...
    code: `const res = await fetch('https://fakeforge.vercel.app/posts/search?q=love');
const data = await res.json();`,
  },
  {
...
// { comments: [...], total: 3, skip: 0, limit: 3 }`,
  },
  {
    ...
    params: [],
    code: `const res = await fetch('https://fakeforge.vercel.app/posts', {
  method: 'POST',
