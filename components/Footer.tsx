...
export default function Footer() {
  return (
    <footer className="bg-[#080810] border-t border-white/[0.06] px-6 py-10">
      <div className="max-w-[960px] mx-auto flex flex-col items-center gap-6">
        ...
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-['Syne',sans-serif] text-[15px] font-bold text-white tracking-tight">
          ...
          {LINKS.map((l) => {
            ...
            return (
              <Comp
                ...
                href={l.href}
                {...(extra as object)}
                className="font-mono text-[11.5px] text-white/30 hover:text-blue-400 transition-colors duration-150"
              >
                {l.label}
              </Comp>
            );
        ...
        <div className="flex items-center justify-between w-full flex-wrap gap-3">
          <span className="font-mono text-[10.5px] text-white/20">
            © 2025 <span className="text-blue-400/50">FakeForge</span> — MIT License
          </span>
          <div className="flex items-center gap-1.5 font-mono text-[10.5px] text-green-400/60 bg-green-400/[0.06] border border-green-400/[0.12] px-2.5 py-[5px] rounded-full">
